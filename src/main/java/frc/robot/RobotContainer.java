...
import frc.robot.Commands.twopiececmd;
...
public class RobotContainer {
  // The robot's subsystems
   ...
   private final Command twopiece = new twopiececmd(IntakeSubsystem, ShooterSubsystem, ConveyorSubsystem, m_robotDrive);
 ...
 //zero robot control
  ...
  public Command getAutonomousCommand() {
    ...
    return new SequentialCommandGroup(
        ...
        firstCommand,
        new conveyorSensorCmd(ConveyorSubsystem,ConveyorConstants.kConveyorVelocity),
        new intakeForTimeCmd(IntakeSubsystem,IntakeConstants.intakeVelocity, 2)
        ),
        new InstantCommand(() -> m_robotDrive.stopModules()),
        secondCommand,
        new ParallelCommandGroup(
