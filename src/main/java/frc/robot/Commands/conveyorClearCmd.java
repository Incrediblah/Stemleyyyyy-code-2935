...
public class conveyorClearCmd extends Command {
  ...
  public conveyorClearCmd(ConveyorSubsystem conveyor, double velocity) {
  ...
  public void end(boolean interrupted) {
   ...
   public boolean isFinished() {
     if(CONVEYOR_SUBSYSTEM.getConveyorSwitchTwoValue() && CONVEYOR_SUBSYSTEM.getConveyorSwitchOneValue() == true){
       return true; 
     }
